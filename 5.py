...
#* даёт возможность произвольное кол-во аргументов
def bar(*args):
    for arg in args:
        print('bar arg =', arg)
...
while not done:
    ...
    pygame.draw.lines(screen, BLACK, False, [[0, 80], [50, 90], [200+x, 80], [220, 30]], 5)
    ...
    pygame.draw.rect(screen, BLACK, [x, 10, 50, 20], 2)

    # Draw a solid rectangle
    pygame.draw.rect(screen, BLACK, [150, 10, 50, 20])

    # Draw a rectangle with rounded corners
    pygame.draw.rect(screen, GREEN, [115+x, 210, 70, 40], 10, border_radius=15)
    pygame.draw.rect(screen, RED, [135, 260-x, 50, 30], 0, border_radius=10, border_top_left_radius=0,
